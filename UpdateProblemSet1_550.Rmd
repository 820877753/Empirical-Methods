...
```
# Part C
The sign should be negative. Given that less-cooked steaks are more likely to be contaiminated and cause sickness (a risk), only more risk-adverse indiviudals tend to opt for it. 
